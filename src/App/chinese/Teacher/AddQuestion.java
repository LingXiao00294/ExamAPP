...
public class AddQuestion {
    ...
    private void getAddQuestionComponent(JFrame frame, JPanel panel) {
        JLabel label = SwingUtils.createLabel("欢迎!", 0, 10, 600, 50, 40);
        panel.add(label);

        JLabel label2 = SwingUtils.createLabel("请选择科目", 0, 70, 600, 50, 25);
        panel.add(label2);
    ...
    private void addInputFields(JFrame frame, JPanel panel) {
        ...
        JButton buttonBack = SwingUtils.createButton("返回管理员页面", 300, 330, 200, 40, 20);
    ...
    private void confirmAddQuestion(JFrame frame) {
        ...
        try {
            ...
            if (i == 1) {
                JOptionPane.showMessageDialog(frame, "添加成功!", "Success", JOptionPane.INFORMATION_MESSAGE);
                clearFields();
            }
        } catch (SQLException e) {
