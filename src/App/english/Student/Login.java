...
public class Login {
    ...
    private void getLoginComponent(JFrame frame, JPanel panel) {
        JLabel label = SwingUtils.createLabel("Student Login", 0, 10, 600, 50, 30);
        panel.add(label);
        ...
        buttonLogin.addActionListener(e -> {
            ...
            try {
                ...
                PreparedStatement pstmt = conn.prepareStatement("SELECT * FROM student WHERE sno = ?/*123 or 1=1 --*/ AND password = ?");
                pstmt.setString(1, studentId);//123 or 1=1 --
